...
export default class MultiSelect extends Component {
  static propTypes = {
    ...
    canAddItemsErrorText: PropTypes.string,
  ...
  static defaultProps = {
    ...
    displayKey: 'name',
    canAddItems: false,
    canAddItemsErrorText: 'No item to display', // TODO: when using the search input,  the search has no match then the 'No item to display' error string pops in place of the default list, handle this behaviour
    onAddItem: () => {}
  };
  ...
  _getSelectLabel = () => {
    ...
    return `${selectText} (${selectedItems.length} sélectionné${selectedItems.length > 1 ? 's' : '' })`;
  };
          ...
          <View style={styles.selectorView(fixedHeight)}>
            <View style={styles.inputGroup}>
              ...
              { !hideSearchBar && (
                ...
                />)}
              {hideSubmitButton && (
                <TouchableOpacity style={{ flex: 1 }} onPress={this._submitSelection}>
                  <Icon
                    name="menu-up"
                    style={[
                      styles.indicator,
                      { paddingLeft: 15, paddingRight: 15, alignSelf: 'flex-end' }
                    ]}
                  />
                </TouchableOpacity>
              )}
              ...
              >
                <TouchableWithoutFeedback onPress={this._toggleSelector}>
                  ...
                  >
                    ...
                    <Icon
                      name={hideSubmitButton && !hideSearchBar ? 'menu-right' : 'menu-down'}
